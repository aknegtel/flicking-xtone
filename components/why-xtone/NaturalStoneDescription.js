...
const LargeFormat = dynamic(() =>
  import("../../public/logos/why-xtone/caballete.svg")
);
const Thickness = dynamic(() =>
  import("../../public/logos/why-xtone/espesoresAltissima.svg")
);

const NaturalStoneDescription = () => {
  const variants = {
    visible: { opacity: 1 },
    hidden: { opacity: 0 },
  };
      ...
      <div className="relative flex flex-col justify-center items-stretch description-section overflow-hidden py-12">
        ...
        >
          <Image
            ...
            src="/static/images/why-xtone/tablas-altissima.webp"
            alt="Why XTONE natural background image"
          />
        </div>
        <div className="sm:w-container container mx-auto absolute self-center flex flex-col justify-center items-center pointer-events-none max-w-lg md:max-w-4xl xl:max-w-6xl gap-24">
          <motion.div
            initial="hidden"
            animate="visible"
            variants={variants}
          ...
          >
            <LargeFormat className="relative w-36 md:w-44 lg:w-48 opacity-60 sm:opacity-100 transform scale-150" />
          ...
          >
            <div className="text-right mr-2 sm:mr-5">
              <h2 className="text-5xl lg:text-6xl xl:text-7xl font-primary font-light uppercase">
                {t("descriptionSection.natural.thickness.title")}
              </h2>
              <p className="mt-4 md:mt-5 font-primary text-xs md:text-sm max-w-sm md:max-w-md text-description">
                {t("descriptionSection.natural.thickness.description")}
              </p>
            </div>
...
export default NaturalStoneDescription;
